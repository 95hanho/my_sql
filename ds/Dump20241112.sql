...
CREATE TABLE `notice` (
  ...
  `manager_comment_latest` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `token` VALUES (1,'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzM4NCJ9.eyJpc3MiOiJteXRlYW0iLCJpYXQiOjE3MzE0MDE4MDEsImV4cCI6MTczMTQxMjYwMX0.KURjOqO3ZXo45qMZ5TSBvje8YKcRIFmnLWLgI-NcUtzK7WtAPTceM5zK0M0xd0-H','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36','0:0:0:0:0:0:0:1','2024-11-12 17:26:16','admin');
...
-- Dump completed on 2024-11-12 20:36:25
