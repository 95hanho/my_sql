...
INSERT INTO `program` VALUES (1,'S13','고객 경험은 어떻게 무기가 되는가','Y','https://ds-api.exc.co.kr/files/program/list/aea286ab-d64a-4ce7-b790-bc8acdf56793.png','Y','#세계 자금 흐름 #AI혁명 #제조업 투자지형도 #제조업 미래전략','8H (8:30~17:30)','천 인재개발원/ DS에듀센터 동탄 Ⅱ<br><span style=\"font-size:16px\"> ※자세한 사항은  수강신청 시스템  및  입과 안내 메일을 참고해주세요.</span>','<p>테스트용</p>',1),(3,'S15','구성원의 탁월함을 이끌어내는 퍼실리테이션','Y','https://ds-api.exc.co.kr/files/program/list/lec_a002_20.jpg','N','#국내 Tech 기업 사례 #네이버 #카카오 #직원경험 #리더의선택 #인사이트 함양','8H (8:30~17:30)','강원도 속초시<br><span style=\"font-size:16px\"> ※자세한 사항은  수강신청 시스템  및  입과 안내 메일을 참고해주세요.</span>','<p>테스트용</p>',1),(4,'S12','리더십 에센스','Y','https://ds-api.exc.co.kr/files/program/list/nlec_a002_14.jpg','Y','#리더의 자기인식 #리더십 현재상태 점검 #나의 리더십 성공모델 #리더십 향상계획 수립','8H (8:30~17:30)','FRONT 개발자 앞<br><span style=\"font-size:16px\"> ※자세한 사항은  수강신청 시스템  및  입과 안내 메일을 참고해주세요.</span>','<p>테스트용</p>',2),(5,'S7','몰입을 이끄는 소통 스킬','Y','https://ds-api.exc.co.kr/files/program/list/nlec_a002_03.jpg','N','#긍정적조직문화 #일중심의소통 #AI #긍정혁명 #소통하는문화구축','8H (8:30~17:30)','우리집 <br><span style=\"font-size:16px\"> ※자세한 사항은  수강신청 시스템  및  입과 안내 메일을 참고해주세요.</span>','<p>테스트용</p>',2);
...
CREATE TABLE `schedule` (
  ...
  `schedule_enrol_start_date` varchar(45) DEFAULT NULL,
  `schedule_enrol_end_date` varchar(45) DEFAULT NULL,
  `group_title` varchar(45) DEFAULT NULL,
  `title` varchar(45) DEFAULT NULL,
  `time` varchar(45) DEFAULT NULL,
  `online` varchar(45) DEFAULT NULL,
  `part_type` varchar(45) DEFAULT NULL,
  `enrol_limit` varchar(45) DEFAULT NULL,
  `enrol_count` varchar(45) DEFAULT NULL,
  `my_enrol_status` varchar(45) DEFAULT NULL,
  `schedule_status` varchar(45) DEFAULT NULL,
  `schedule_start_date_add_date` varchar(45) DEFAULT NULL,
  `schedule_after_date` varchar(45) DEFAULT NULL,
  `schedule_group_num` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2024-11-14 17:46:44
